...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ColorStateList itemTextColor = a.hasValue(C0000R.styleable.NavigationView_itemTextColor) ? a.getColorStateList(C0000R.styleable.NavigationView_itemTextColor) : null;
