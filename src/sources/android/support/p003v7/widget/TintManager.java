...
public final class TintManager {
    ...
    public Drawable getDrawable(int resId, boolean failIfNotKnown) {
        ...
        if (tintList != null) {
            ...
            return new LayerDrawable(new Drawable[]{getDrawable(C0232R.C0233drawable.abc_cab_background_internal_bg), getDrawable(C0232R.C0233drawable.abc_cab_background_top_mtrl_alpha)});
    ...
    private static boolean isInTintList(int drawableId) {
        return arrayContains(TINT_COLOR_CONTROL_NORMAL, drawableId) || arrayContains(COLORFILTER_TINT_COLOR_CONTROL_NORMAL, drawableId) || arrayContains(COLORFILTER_COLOR_CONTROL_ACTIVATED, drawableId) || arrayContains(TINT_COLOR_CONTROL_STATE_LIST, drawableId) || arrayContains(COLORFILTER_COLOR_BACKGROUND_MULTIPLY, drawableId) || arrayContains(TINT_CHECKABLE_BUTTON_LIST, drawableId) || drawableId == C0232R.C0233drawable.abc_cab_background_top_material;
    }
