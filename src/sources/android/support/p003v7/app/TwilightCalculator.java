...
class TwilightCalculator {
    ...
    public void calculateTwilight(long time, double latiude, double longitude) {
        ...
        double solarTransitJ2000 = ((double) (f18J0 + ((float) Math.round(((double) (daysSince2000 - f18J0)) - arcLongitude)))) + arcLongitude + (0.0053d * Math.sin((double) meanAnomaly)) + (-0.0069d * Math.sin(2.0d * solarLng));
